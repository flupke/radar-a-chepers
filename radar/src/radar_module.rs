// LD2451 has a one-byte count and five bytes per target, plus framing.
pub const MAX_TARGETS_PER_FRAME: usize = u8::MAX as usize;
pub const MAX_TARGET_FRAME_LENGTH: usize = 10 + 2 + 5 * MAX_TARGETS_PER_FRAME;
...
pub trait RadarModule {
    ...
    /// Length of a frame beginning at buffer[0], or None until its length is known.
    ...
    fn log_frame_details(&self, _frame: &Self::TargetFrame) {}
